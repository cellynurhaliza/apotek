...
class UserController extends Controller
{
    ...
    public function loginAuth(Request $request)
    {
        ...
        // dd($user);
        if(Auth::attempt($user)) { //memastikan bahwa di user yang login itu sesuai data yang ada di database yang sudah terdaftar lalu si user diberikan session authnya bahwa data user tersebut berhasil login
